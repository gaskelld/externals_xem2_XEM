	...
	real*8 wp,ww1,ww2, w11, w22, w11tmp,w22tmp,nu,p
	...
	amn = 0.939565
	ama=avgM
c the esep values below are for proton separation energies
	if(aa.eq.2) then
	   esep=0.002225
	...
	elseif (aa.eq.27) then
	   esep=0.00827
	elseif (aa.eq.40) then
	   esep=0.008328
	elseif ((aa.eq.48).and.(zz.eq.20)) then
	   esep=0.015802
	elseif ((aa.eq.48).and.(zz.eq.22)) then
	   esep=0.011445
	elseif (aa.eq.54) then
	   esep=0.008853
	elseif (aa.eq.56) then
	   esep=0.010184
	elseif (aa.eq.58) then
	   esep=0.008172
	elseif ((aa.eq.64) .and. (zz.eq.28)) then
	   esep=0.01254
	elseif ((aa.eq.64).and.(zz.eq.29)) then
	   esep=0.007201
	elseif ((aa.eq.63).and.(zz.eq.29)) then
	   esep=0.006122
	elseif(aa.eq.108) then
	   esep=0.006523
	elseif(aa.eq.119) then
	   esep=0.010126
	elseif (aa.eq.197) then
	   esep=0.005784
	elseif(aa.eq.232) then
	   esep=0.007605
	endif
c	ama = ama_1 + amp - esep
	ama_1=ama+esep-amp
...
!	do smearing correction
	...
	1     .wpmin2) goto 10
	    ...
	    call F1F2IN21(dble(1.),dble(1.),rq2,wp**2,w11,w22)
	    ...
	    w11=0.
	    w22=0.
	    call F1F2IN21(dble(0.),dble(1.),rq2,wp**2,w11,w22)
