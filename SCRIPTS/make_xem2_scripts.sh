...
#    echo $angle
    set angle_name=`echo "$angle" | tr '.' 'p'`
    set infile = "${angle_name}_${targ}_part3"
    set scriptfile = "${angle_name}_${targ}_part3.sh"
    echo $infile
    cd /group/c-xem2/gaskelld/GIT/externals_xem2_XEM/hcswif/FARM_SCRIPTS
    cat script_header.txt >! $scriptfile
    echo "/u/group/c-xem2/gaskelld/GIT/externals_xem2_XEM/run_extern" $infile >> $scriptfile
...
#    echo $angle
    set angle_name=`echo "$angle" | tr '.' 'p'`
    set infile = "${angle_name}_${targ}_part4"
    set scriptfile = "${angle_name}_${targ}_part4.sh"
    echo $infile
    cd /group/c-xem2/gaskelld/GIT/externals_xem2_XEM/hcswif/FARM_SCRIPTS
    cat script_header.txt >! $scriptfile
    echo "/u/group/c-xem2/gaskelld/GIT/externals_xem2_XEM/run_extern" $infile >> $scriptfile
...
#    echo $angle
    set angle_name=`echo "$angle" | tr '.' 'p'`
    set infile = "${angle_name}_${targ}_part5"
    set scriptfile = "${angle_name}_${targ}_part5.sh"
    echo $infile
    cd /group/c-xem2/gaskelld/GIT/externals_xem2_XEM/hcswif/FARM_SCRIPTS
    cat script_header.txt >! $scriptfile
    echo "/u/group/c-xem2/gaskelld/GIT/externals_xem2_XEM/run_extern" $infile >> $scriptfile
